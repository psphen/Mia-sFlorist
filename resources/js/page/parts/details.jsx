                    ...
                    <div className="p-3">
                        <div className="card product-card h-100">
                            <div className="card-img-wrapper-pink d-flex justify-content-center">
                                ...
                                <img src="/image/flower-5.png" alt="home-page" className="img-fluid position-relative mt-3" style={{ height: '224px' }}/>
                            </div>
                            <div className="card-body text-center">
                                <h6 className="card-title">Floral arrangement of the Day Roses and sunflowers</h6>
                    ...
                    <div className="p-3">
                        <div className="card product-card h-100">
                            <div className="card-img-wrapper-blue d-flex justify-content-center">
                                <span className="new-badge fw-800">20% off</span>
                                <img src="/image/flower-6.png" alt="home-page" className="img-fluid position-relative mt-3" style={{ height: '224px' }}/>
                            </div>
                            <div className="card-body text-center">
                                <h6 className="card-title">Floral arrangement for funeral</h6>
                    ...
                    <div className="p-3">
                        <div className="card product-card h-100">
                            <div className="card-img-wrapper-blue d-flex justify-content-center">
                                ...
                                <img src="/image/flower-8.png" alt="home-page" className="img-fluid position-relative mt-3" style={{ height: '224px' }}/>
                            </div>
                            <div className="card-body text-center">
                                <h6 className="card-title">Floral arrangement of the Day Roses and sunflowers</h6>
                                <i className="card-price text-pink fw-800">$99,00</i>
